...
extension CatResponseDTO {
    ...
    public init(catEntity: CatEntity) {
        self.id = nil
        self.url = catEntity.imageUrl?.absoluteString
        self.width = Int(catEntity.size.width)
        self.height = Int(catEntity.size.height)
        self.breeds = [
            Breed(
                weight: nil,
                id: nil,
                name: catEntity.species,
                cfa_url: nil,
                vetstreet_url: nil,
                temperament: catEntity.features,
                origin: nil,
                country_codes: nil,
                country_code: nil,
                description: nil,
                ...
                suppressed_tail: nil,
                short_legs: nil,
                wikipedia_url: catEntity.wikipedia?.absoluteString,
                hypoallergenic: nil,
